...
export default function AuthLayout({children}:{children:React.ReactNode}) {
    ...
    return (
        <div className='min-h-screen w-screen relative z-10 paddingx md:flex md:items-center max-md:pt-8 overflow-hidden'>
            ...
            <div className='md:w-full relative lg:left-24 z-30'>
                <h1 className="text-center text-main lg:relative lg:right-28 font-bold text-2xl pb-10 uppercase">Mylogo</h1>
